    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light header">
            <div class="container-fluid justify-content-between">
                ...
                <div class="d-flex">
                    <!-- Brand -->
                    <a class="mb-1 navbar-brand me-2 d-flex align-items-center" href="https://grvsummit.com">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item me-6 me-lg-1">
                        ...
                        @else
                        <button type="submit" class="btn btn-succes btn-v" onclick="window.location.href='{{ route('login') }}'; return false;">Login</button>
                        @endif
                    </li>
                </ul>
